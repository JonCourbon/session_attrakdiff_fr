...
<body>
  ...
  <p>Dans le cadre d'un projet sur l'expérience utilisateur, nous souhaiterions évaluer vos impressions sur le 
   <?php echo $typeelement;?> <strong><?php echo $nom;?></strong>. Ce questionnaire se présente sous forme de paires de mots pour vous assister dans l'évaluation du système. Chaque paire représente des contrastes. Les échelons entre les deux extrémités vous permeDent de décrire l'intensité de la qualité choisie. </p>
